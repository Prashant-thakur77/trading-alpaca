...
- [x] Live session #3 for footage; record + edit 2–4 min video (honest
      ...
      → 2026-09-04: docs/press/demo.mp4, 4:22. Ten scenes over the live site
...
RESOLVED 2026-08-30: all nine removed, with tests/test_core.py. Suite 938 →
900; the 38 dropped tests covered MACD, Bollinger squeezes, crypto pair config
and the layered risk manager. Closure is now clean — 16 shipping modules, zero
orphans, no kraken references anywhere in the tree.
